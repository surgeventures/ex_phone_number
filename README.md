...
Based on Google's [libphonenumber](https://github.com/googlei18n/libphonenumber) (current metadata version: 8.12.18).
...
```elixir
def deps do
  [{:ex_phone_number, git: "https://github.com/surgeventures/ex_phone_number.git", tag: "v0.2.3"}]
end
```
